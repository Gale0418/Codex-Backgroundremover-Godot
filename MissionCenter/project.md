...
- 野路子角度：保留「快速模式」讓使用者先拿到可用成品，髮絲模式再逐步改善，避免第一版變成大型研究專案。
...
- 2026-05-23：新增匯出成果預覽、Godot 每幀座標輸出，並明確保留來源浮水印內容不自動移除。
- 2026-05-23：新增動畫預覽 canvas 與內建測試背景，準備推送到公開 GitHub repo。

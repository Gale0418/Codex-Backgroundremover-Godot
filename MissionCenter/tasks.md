...
| BR-T4 | 本機 Web 專案骨架 | Task | BR-E1 | P1 | Done | Codex | BR-T3 | 維持本機服務可啟動 | 可啟動 localhost 並看到工具主畫面 | 3 | web, node | 已可在 5177 使用 |
| BR-T5 | 影片匯入與背景色自動偵測 | Task | BR-E1 | P1 | Done | Codex | BR-T4 | 保留手動覆蓋背景色 | 對白底/黑底/綠幕測資回傳合理色塊 | 3 | detection, preview | 偵測結果可手動覆蓋 |
